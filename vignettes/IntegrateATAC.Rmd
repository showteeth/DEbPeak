...
```{r debatac_atac_peak_annotation_plot, fig.height = 10, fig.width = 14, fig.align = "center", warning=FALSE}
...
### Integrate
```{r debatac_integrate}
debatac.res = DEbPeak(de.res = debatac.dds.results.ordered, peak.res = atac.peak.anno, peak.anno.key = "Promoter", merge.key="SYMBOL")
head(debatac.res)
```
