...
```{r debchip_read_profile, eval=FALSE}
ReadProfile(bw.folder = '/home/songyabing/R/learn/tmp/DEbPeak/deeptools/ChIP-seq', species = "Mouse",
            deeptools.path = "~/anaconda3/bin", 
            out.folder = "/home/songyabing/R/learn/tmp/DEbPeak/deeptools/ChIP-seq")
```

```{r debchip_read_profile_plot, out.height = 500, out.width=300, include=TRUE, fig.align="center", warning=FALSE, echo=FALSE}
knitr::include_graphics("/home/songyabing/R/learn/tmp/DEbPeak/deeptools/ChIP-seq/matrix_tss.png")
```
