...
peak.meta.file <- system.file("extdata", "consensus_peak_anno.txt", package = "DEbPeak")
...
```{r debchip_de_integrate_whole_network, warning=FALSE, fig.height = 10, fig.width = 10, fig.align = "center"}
