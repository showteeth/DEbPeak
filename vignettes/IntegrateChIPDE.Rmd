...
debchip.res <- DEbPeak(
    ...
    signif = "pvalue", signif.threshold = 0.05, l2fc.threshold = 0, 
    peak.signif = "pvalue", label.key = NULL,
    peak.signif.threshold = 0.05, peak.l2fc.threshold = 0, species = "Mouse", 
    merge.key = "SYMBOL", n.cores = 5,
...
FindMotif(inte.res = debchip.res, peak.motif.key = "Up_Up", peak.mode = "diff", 
...
```{r debchip_de_integrate_motif_up_denovo, eval = FALSE}
# this step is time consuming!
MotifDiscovery(inte.res = debchip.res, peak.motif.key = "Up_Up",
...
```{r debchip_de_integrate_motif_up_comparison, eval = FALSE}
verteb.motifs = system.file("extdata", "homer_verteb.motifs.meme", package = "DEbPeak")
# this step is time consuming!
chip.denovo.motif = MotifCompare(motif.folder = "/path/to/denovo/output",
