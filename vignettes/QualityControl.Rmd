...
```{r qc_counts_cpm, warning=FALSE,fig.height = 5, fig.width = 7, fig.align = "center"}
...
```{r qc_counts_saturation, warning=FALSE,fig.height = 5, fig.width = 7, fig.align = "center"}
...
```{r qc_samples_sr, warning=FALSE,fig.height = 5, fig.width = 14, fig.align = "center"}
...
### PCA
```{r qc_samples_pca, warning=FALSE,fig.height = 6, fig.width = 6, fig.align = "center"}
